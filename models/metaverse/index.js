...
function post(message) {
    return Metaverse.wallet.fromMnemonic(config.seed)
        .then((wallet) =>
            ...
            .then((result) => Metaverse.transaction_builder.send(result.utxo, wallet.getAddresses()[0], {}, wallet.getAddresses()[1], result.change, undefined, (Array.isArray(message) ? message : [message])))
